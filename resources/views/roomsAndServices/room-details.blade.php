...
<head>
    ...
    <title>Room Details - Azure Haven</title>
...
<body>
    ...
    <main>
        <div class="hero-details-section" id="hero-details"></div>
        ...
        <div class="container">
            ...
            <div class="gallery-grid" id="gallery-grid">
                <!-- The JavaScript will now correctly insert two <img> tags directly here -->
            </div>

            <div class="details-content-wrapper">
                <div class="details-left-panel">
                    <div class="price-tag" id="details-price"></div>
                    ...
                    <div class="guest-info">
                        ...
                        Guest: <strong id="details-guests"></strong>
                    </div>
                    
                    <div class="amenities-grid">
                        <div class="amenities-column">
                            <h4>Features</h4>
                            <ul id="details-features-list"></ul>
                        </div>
                        <div class="amenities-column">
                            <h4>Inclusion</h4>
                            <ul id="details-inclusions-list"></ul>
                        </div>
                    </div>
                </div>

                <aside class="details-right-panel">
                    <div class="booking-widget">
                        ...
                        <form action="{{ route('userbookings') }}" method="GET">
                            ...
                            <div class="form-group-details"><i class="fa-solid fa-user"></i><input type="number" name="guests" placeholder="Guest" min="1" required></div>
                            <div class="form-group-details"><i class="fa-solid fa-bed"></i><input type="number" name="rooms" placeholder="Rooms" min="1" max="3" required></div>
