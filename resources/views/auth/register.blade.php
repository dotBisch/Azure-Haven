...
<head>
    ...
    <title>Sign Up - Azure Haven</title>
            ...
            <div class="auth-card">
                ...
                <div class="auth-image-panel">
                    <div class="toggle-buttons">
                        ...
                        <a href="{{ route('register') }}" class="toggle-btn active">Sign Up</a>
                    </div>
                </div>

                <!-- Right Panel with Form -->
                <div class="auth-form-panel">
                    <img src="{{ asset('assets/images/azure_logo.png') }}" alt="Azure Haven Logo" class="form-logo">
                    
                    <h1>Create an account</h1>
                    <h2><span class="highlight-blue">Azure Haven</span> awaits!</h2>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Terms and Privacy Policy (if Jetstream feature is enabled) -->
