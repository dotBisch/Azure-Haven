            ...
            <div class="login-card">
                ...
                <div class="login-image-panel">
                    <div class="toggle-buttons">
                        ...
                        <button class="toggle-btn" onclick="window.location.href='{{ route('register') }}'">Sign Up</button>
                    </div>
                </div>
                ...
                <div class="login-form-panel">
                    ...
                    <h1>Welcome!</h1>
                    <h2>Your <span class="highlight-blue">Haven</span> Starts Here</h2>
